...
3. For DFT calculations: ALWAYS ask user for basis set, functional (xc), charge, and spin BEFORE running, unless user explicitly says "decide yourself", "fastest settings", "default", or already specified parameters. Common choices: basis=def2-svp (fast), def2-tzvp, def2-tzvppd (accurate); xc=b3lyp, pbe0, wb97m-d3bj (recommended).
