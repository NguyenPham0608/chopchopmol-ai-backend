...
TOOLS_JSON = """[
  ...
  {"type":"function","function":{"name":"create_chart","description":"Display line/bar/scatter chart from x and y arrays. Use scanXValues from calculate_all_energies for x-axis.","parameters":{"type":"object","properties":{"type":{"type":"string","enum":["line","bar","scatter"],"description":"Chart type (default: line)"},"title":{"type":"string","description":"Chart title"},"xLabel":{"type":"string","description":"X-axis label"},"yLabel":{"type":"string","description":"Y-axis label"},"x":{"type":"array","items":{"type":"number"},"description":"X values"},"y":{"type":"array","items":{"type":"number"},"description":"Y values"},"labels":{"type":"array","items":{"type":"string"},"description":"Series labels"}},"required":["x","y"]}}},
