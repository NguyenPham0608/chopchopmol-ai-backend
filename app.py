...
TOOLS_JSON = """[
  ...
  {"type":"function","function":{"name":"angle_scan","description":"Perform an angle scan: rotate a fragment around an axis perpendicular to the plane formed by 3 atoms (A-B-C) through 360°, generating frames. B is the pivot point. Similar to rotational scan but the axis is perpendicular to the angle plane.","parameters":{"type":"object","properties":{"atom1":{"type":"integer","description":"First atom index (0-indexed)"},"atom2":{"type":"integer","description":"Vertex/pivot atom index (0-indexed)"},"atom3":{"type":"integer","description":"Third atom index (0-indexed)"},"atomsToMove":{"type":"array","items":{"type":"integer"},"description":"Array of atom indices to rotate (0-indexed)"},"increment":{"type":"number","description":"Step size in degrees (default: 10)"}},"required":["atom1","atom2","atom3","atomsToMove"]}}}
]"""
