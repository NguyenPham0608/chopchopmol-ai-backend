...
app = Flask(__name__)
CORS(app, origins=["https://chopchopmol.com", "http://localhost:*", "http://127.0.0.1:*"])
...
TOOLS = [
    ...
    {"type": "function", "function": {"name": "add_atom", "description": "Add a new atom at a specific position or bonded to a selected atom", "parameters": {"type": "object", "properties": {"element": {"type": "string", "description": "Element symbol (e.g., 'C', 'H', 'O')"}, "x": {"type": "number", "description": "X coordinate"}, "y": {"type": "number", "description": "Y coordinate"}, "z": {"type": "number", "description": "Z coordinate"}, "bondToSelected": {"type": "boolean", "description": "If true, add atom bonded to the selected atom"}}, "required": ["element"]}}},
    ...
    {"type": "function", "function": {"name": "select_atoms_by_element", "description": "Select all atoms of a specific element type", "parameters": {"type": "object", "properties": {"element": {"type": "string", "description": "Element symbol (e.g., 'C', 'N', 'O', 'H')"}, "add": {"type": "boolean", "description": "Add to current selection"}}, "required": ["element"]}}},
    ...
    {"type": "function", "function": {"name": "rotate_molecule", "description": "Rotate selected atoms around the defined axis by given angle", "parameters": {"type": "object", "properties": {"angle": {"type": "number", "description": "Rotation angle in degrees (-180 to 180)"}}, "required": ["angle"]}}},
    {"type": "function", "function": {"name": "translate_molecule", "description": "Move selected atoms along the defined axis by given distance in angstroms", "parameters": {"type": "object", "properties": {"distance": {"type": "number", "description": "Distance to translate in angstroms"}}, "required": ["distance"]}}},
    {"type": "function", "function": {"name": "change_atom_element", "description": "Change the element type of selected atoms", "parameters": {"type": "object", "properties": {"element": {"type": "string", "description": "New element symbol"}}, "required": ["element"]}}},
    ...
    {"type": "function", "function": {"name": "measure_distance", "description": "Measure and display the distance between 2 selected atoms", "parameters": {"type": "object", "properties": {}}}},
    {"type": "function", "function": {"name": "measure_angle", "description": "Measure angle between 3 atoms (middle atom is vertex)", "parameters": {"type": "object", "properties": {}}}},
    {"type": "function", "function": {"name": "measure_dihedral", "description": "Measure dihedral/torsion angle between 4 atoms", "parameters": {"type": "object", "properties": {}}}},
    ...
    {"type": "function", "function": {"name": "create_fragment", "description": "Create a fragment from currently selected atoms", "parameters": {"type": "object", "properties": {}}}},
    {"type": "function", "function": {"name": "isolate_selection", "description": "Isolate selected atoms/fragment to view separately", "parameters": {"type": "object", "properties": {}}}},
    ...
    {"type": "function", "function": {"name": "toggle_labels", "description": "Show or hide atom labels", "parameters": {"type": "object", "properties": {"show": {"type": "boolean", "description": "True to show, false to hide"}, "showIndices": {"type": "boolean", "description": "Show atom numbers instead of elements"}}, "required": ["show"]}}},
    {"type": "function", "function": {"name": "select_connected", "description": "Select atoms directly bonded to currently selected atoms", "parameters": {"type": "object", "properties": {}}}},
    ...
    {"type": "function", "function": {"name": "set_style", "description": "Change visual appearance of the molecule", "parameters": {"type": "object", "properties": {"roughness": {"type": "number", "description": "Surface roughness 0-1"}, "metalness": {"type": "number", "description": "Metallic look 0-1"}, "opacity": {"type": "number", "description": "Transparency 0-1"}, "atomSize": {"type": "number", "description": "Atom size multiplier 0.1-3"}, "backgroundColor": {"type": "string", "description": "Background color hex"}}}}},
    ...
    {"type": "function", "function": {"name": "save_xyz", "description": "Export the molecule as XYZ file format", "parameters": {"type": "object", "properties": {}}}},
    {"type": "function", "function": {"name": "load_molecule", "description": "Search PubChem database for a molecule by name", "parameters": {"type": "object", "properties": {"name": {"type": "string", "description": "Molecule name to search"}}, "required": ["name"]}}},
...
def build_system_prompt(state):
    return SYSTEM_PROMPT.format(
        atom_info=f"{state.get('atomCount', 0)} atoms" if state.get('hasAtoms') else "None loaded",
